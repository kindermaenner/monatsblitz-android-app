...
import de.sgkoenigslutter.monatsblitz.data.model.*
...
class MappingUtilsTest {
    ...
    fun gameDtoToGame_and_back() {
        ...
        val tournament = Tournament(Id = 42, Mode = GameMode.BLITZ_3_2, Date = LocalDate.now(), players = listOf(p1, p2), doubleRound = false)
    ...
    fun invalidGame_returnsNull() {
        ...
        val tournament = Tournament(Id = 10, Mode = GameMode.BLITZ_3_2, Date = LocalDate.now(), players = listOf(p1), doubleRound = false)
